...
public interface ITaskRepository
{
    ...
    Task<(List<Subtask> subtasks, Dictionary<Guid, DateTime> dateTimes)> GetSubTasks(
        Status? status,
        bool? isOverdue,
        Guid? assigneeId,
        Guid? taskId,
    ...
    Task UpdateSubtaskStatus(Guid subtaskId, Status status, CancellationToken ct = default);
